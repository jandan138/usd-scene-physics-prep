...
#     # xform = UsdGeom.Xform.Get(prim)
#     # print(xform)
#     translate_attr = prim.GetAttribute("xformOp:translate").Get()
#     return translate_attr


# def set_mass(prim, center_mass, density):
#     mass = UsdPhysics.MassAPI.Apply(prim)
#     mass.GetCenterOfMassAttr().Set(center_mass)
#     mass.GetDensityAttr().Set(density)


# def get_mass(prim):
#     mass = prim.GetAttribute("physics:mass").Get()
#     center_of_mass = prim.GetAttribute("physics:centerOfMass").Get()
#     density = prim.GetAttribute("physics:density").Get()
#     return mass, center_of_mass, density


# # 示例使用
# stage_path = '/ssd/tianshihan/fixed/target/scenes/MV7J6NIKTKJZ2AABAAAAADA8_usd/oven.usd'
# prim_path = '/Root/model_ab989964acd0c5fa17b01e78eeaf07e2_0/Instance/Group_200'
...
# 我这里为了加载 PhysxSchema，必须先初始化 isaac sim runtime（不太确定为啥）
from isaacsim import SimulationApp
...
# 示例使用
stage_path = '/ssd/tianshihan/fixed/target/scenes/MVUCSQAKTKJ5EAABAAAAAAY8_usd/microwave.usd'
stage = Usd.Stage.Open(stage_path)
instance_prim = stage.GetPrimAtPath("/Root/model_544bf45179900be126e7b8dfb437304f_0/Instance")
