...
stage_path = "/ssd/tianshihan/target_69_new/scenes/MVUCSQAKTKJ5EAABAAAAACI8_usd/start_result_fix_bk.usd"
...
# 设置相机的位置和旋转
camera_origin_translate = Gf.Vec3d(90, 240, 150)
camera_origin_rotate = Gf.Vec3f(90, 0, -170)
...
random_model_semantics = ["sofa_chair", "table", "couch", "chair", "washingmachine"]
...
random_material_semantics = ["curtain", "wall"]
...
for _ in range(random_times):
    ...
    for i in range(110):
        ...
        if i >= 10:
            get_camera_rgba(camera, f"/ssd/tianshihan/test/rgba_data/scene_3/data_{rgba_id}.png")
            rgba_id += 1
