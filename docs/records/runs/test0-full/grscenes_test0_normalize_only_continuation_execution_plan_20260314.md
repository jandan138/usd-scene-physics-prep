...
- status and rationale:
  `docs/records/runs/test0-full/grscenes_test0_phase1_status_and_phase2_probe_plan_20260314.md`
- original full normalize-only runbook:
  `docs/records/runs/test0-full/grscenes_test0_normalize_only_runbook.md`
