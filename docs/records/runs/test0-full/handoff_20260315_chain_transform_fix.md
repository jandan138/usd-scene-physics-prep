...
- `docs/records/runs/test0-full/` — 多份调查文档
...
| 文档 | 内容 |
|------|------|
| `docs/records/runs/test0-full/displacement_root_cause_chain_transform_20260315.md` | Root cause 分析 (正确版) |
| `docs/records/runs/test0-full/grscenes_test0_rebuilt_phase1_allowlist_verdict_20260315.md` | Phase 1 allowlist 判定 |
| `docs/changes/2026-03-15_matrix_multiply_order_fix.md` | 修复变更记录 |
| `docs/operations/smoke_test_gap_analysis.md` | Smoke test 覆盖缺口分析 |
| `docs/records/runs/test0-full/grscenes_test0_normalize_only_runbook.md` | 全量执行 runbook |
