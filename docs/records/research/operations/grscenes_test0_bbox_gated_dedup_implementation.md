...
- [GRScenes-test0-rebuilt-normalize-prededup Baseline Adoption](../../runs/test0-full/grscenes_test0_rebuilt_prededup_baseline_adoption_20260327.md)
- prededup_baseline_binding_verdict.json（仓库内未收录）
...
- [资产去重落地方案 C1 执行手册（Scene 侧引用归一 + Instancing）](../../../operations/asset_dedup_c1_scene_instancing_runbook.md)
- [C1 规模化执行与审核流程（可控批处理版）](../../../operations/asset_dedup_c1_scaling_workflow.md)
