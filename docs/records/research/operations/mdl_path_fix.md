...
- [Isaac Sim MDL Workflow](../../../operations/isaacsim_mdl_workflow.md) -- general MDL reference
- [Asset Transform Normalization](../../../how-to/normalize_asset_transforms.md) -- the normalization step that introduced the absolute paths
