...
| `docs/operations/dlc/README.md` | Section 5.5: stated normalize "does not need Isaac Sim"; call chain diagram was incorrect; dependency table was incorrect |
...
| `docs/operations/dlc/README.md` | Section 5.5: updated to say "Requires Isaac Sim Python"; updated underlying call; Section 5.6: updated similarly; call chain diagram corrected; dependency table updated (~9 locations total) |
