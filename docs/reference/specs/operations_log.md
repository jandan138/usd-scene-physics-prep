...
- 文档同步：已更新 `docs/reference/specs/*` 与 `docs/reference/specs-normalizer/*` 中的结构示例与说明。
...
- 备注：
  ...
  - 该结构与规范文档 `docs/reference/specs/dataset_structure_interpretation.md` 的 Materials 部分一致（`Material/mdl` 与小写 `textures`）。
