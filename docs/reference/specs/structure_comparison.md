...
## 概述
- 本文对比当前项目在处理后生成的目录结构（`target/Materials | target/models | target/scenes`）与规范化结构提案（`docs/reference/specs/dataset_structure_interpretation.md` 中的 Materials/Assets/Scenes）。
