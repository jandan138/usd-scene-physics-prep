---
title: Interaction Preprocessing Usage
code_reference: set_physics/preprocess_for_interaction.py
...
# 使用指南：Interaction Preprocessing
...
- 更完整用法（命令模板/参数说明）：`prep_interaction_root_scene.md`
